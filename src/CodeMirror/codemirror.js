window.CodeMirror = (function () {
    function CodeMirror(place, givenOptions) {
        ...
        var lineSpace = elt("div", [
            measure, 
            cursor, 
            widthForcer, 
            selectionDiv, 
            lineDiv
        ], null, "position: relative; z-index: 0");
        ...
        function readInput() {
            ...
            if(same < prevInput.length) {
                ...
                if(overwrite && posEq(sel.from, sel.to) && !pasteIncoming) {
                    sel.to = {
                        line: sel.to.line,
        ...
        function scrollCursorIntoView() {
            ...
            if(coords.y + box.top < 0) {
                ...
                if(coords.y + box.top + textHeight() > (window.innerHeight || document.documentElement.clientHeight)) {
                    doScroll = false;
                }
            }
            if(doScroll != null) {
        ...
        function matchBrackets(autoclear) {
            ...
            var two = found.pos != null && markText({
                line: i,
                ch: found.pos
            }, {
                line: i,
